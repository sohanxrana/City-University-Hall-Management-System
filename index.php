...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light sticky-top p-0 mt-2 mb-2">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-3 p-lg-0">
                    <a href="public/index.html" class="city-logo"><img src="assets/img/city-logo.png" alt="CU Logo"
                            width="90px" height="auto"></a>
                    <a href="public/index.html" class="nav-item nav-link active">Home</a>
    ...
    <section id="facility">
        ...
        <div class="container">
            ...
            <div class="see_more_btn">
                <a href="view/pages/hallfacilities.html" class="s_m_btn">SEE MORE</a>
            </div>
        </div>
        <!-- container end -->
    </section>
    ...
    <section id="in_room_facility">
        <div class="container">
            ...
            <div class="see_more_btn">
                <a href="view/pages/in-roomFacilities.html" class="s_m_btn">See More</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="assets/img/male1.jpg" alt="male1">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="assets/img/avater for rafiq.png" alt="male2">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
                            </div>
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Md Rafiq Islam</h5>
                            <small>MH Hall</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="assets/img/female1.jpg" alt="">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="assets/img/female.jpg" alt="">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
    ...
    <section id="faq">
        <div class="container">
            ...
            <div class="see_more_btn">
                <a href="/view//pages/faq.html" class="s_m_btn">See More</a>
            </div>
        </div>
    </section>
    <!-- ----------------------------------------------------- FAQ end  --------------------------------------------->
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="assets/img/testimonial-1.png"
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="assets/img/testimonial-2.jpeg"
                        style="width: 80px; height: 80px;">
