    ...
    <div class="main-content">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <span class="navbar-brand">Welcome, <?php echo htmlspecialchars($student['username']); ?>!</span>
            </div>
        </nav>
        <div id="dashboard-section" class="section active">
            <h2>Dashboard Overview</h2>
            <p>Welcome to your student dashboard. Select a menu item to view more details.</p>
        </div>
        <div id="room-booking-section" class="section">
            <h2>Room Booking</h2>
            <p>Your booked room: <?php echo $student['booked_room']; ?></p>
        </div>
        <div id="playground-section" class="section">
            <h2>Playground Booking</h2>
            <p>Your playground booking status: <?php echo $student['playground_booking']; ?></p>
        </div>
        <div id="payment-section" class="section">
            <h2>Payments</h2>
            <p>Payment Status: <?php echo $student['payment_status']; ?></p>
        </div>
        <div id="meal-plan-section" class="section">
            <h2>Meal Plan</h2>
            <p>Meal Plan: <?php echo $student['meal_plan']; ?></p>
        </div>
